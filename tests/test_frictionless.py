...
from datatools.utils import validate_resource
...
class TestFrictionless(unittest.TestCase):
    ...
    def test_constraints(self):
        ...
        self.assertRaises(
            ...
            validate_resource,
            self.create_single_val_resource(
                "0911", type="string", constraints={"minLength": 5, "maxLength": 5}
            ),
        )
        ...
        self.assertRaises(
            ...
            validate_resource,
            self.create_single_val_resource(
                "ax", type="string", constraints={"pattern": "^a[0-9]{1,2}.*$"}
            ),
        )
        ...
        self.assertRaises(
            ...
            validate_resource,
            self.create_single_val_resource(
                "c", type="string", constraints={"enum": ["a", "b"]}
            ),
        )
